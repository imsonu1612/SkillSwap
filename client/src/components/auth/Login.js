...
import { Eye, EyeOff, Mail, Lock, Users, Sparkles, ShieldCheck, ArrowRight, ArrowLeft } from 'lucide-react';
      ...
      <div className="relative z-10 w-full max-w-6xl grid gap-8 lg:grid-cols-[1.05fr_0.95fr] items-stretch">
        ...
        <div className="flex items-center justify-center">
          <div className="relative w-full max-w-md rounded-[2rem] border border-white/20 bg-black/15 p-6 shadow-2xl backdrop-blur-sm sm:p-8">
            <div className="pointer-events-none absolute -inset-[1px] rounded-[2rem] opacity-0 transition-opacity duration-700 hover:opacity-70" style={{ boxShadow: '0 0 15px 5px rgba(255,255,255,0.05)' }} />
